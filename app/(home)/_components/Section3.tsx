...
const Section3 = () => {
  ...
  return (
    <section className="py-10 lg:py-20 bg-section3Bg">
      <div className="container">
        <h2 className="text-[2rem] leading-[100%] tracking-[1px] capitalize text-center text-white font-bold xl:text-[2.5rem]">
          FloorWalk Marketplace
        </h2>
        <p className="text-base text-center leading-[100%] pt-2 xl:text-lg text-white font-normal font-lato">
          A quicker way to audit your stores. FloorWalk marketplace allows you
          to choose your solution from our product list, setup your project, and
          make it live on-the-go. It allows you to execute your smaller
          straightforward audit and research projects and get insights in a
          jiffy.
        </p>
      </div>
      <div className="container pt-10 grid lg:grid-cols-2 gap-5">
